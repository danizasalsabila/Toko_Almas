...
<header>
    ...
    <p>BRAND OBAT</p>
    <button type="button" class="btn btn-info" style="margin-top: 70px; margin-left: 101px; background-color: CadetBlue;"> <a href="tambahprodusen.php" style="color: Ivory;">+ add more</a></button> 
    ...
    <table align="center" border="1" cellpadding="10" cellspacing="0">
        ...
        <tr>
            ...
            <td>
                <a href="ubahprodusen.php?id_produsen= <?= $row["id_produsen"]; ?>">change</a>
                <a href="hapusprodusen.php?id_produsen=<?= $row["id_produsen"]; ?>"onclick="return confirm('apakan anda yakin akan meenghapus data?');">delete </a>
            </td>
