...
<head>
    ...
    <title>Tambah Konsumen | Sistem Informasi Toko Almas</title>
</head>
<body>
<header>
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
            <a class="navbar-brand text-black" style="font-size: 28px; color: CadetBlue; text-shadow: 1px 1px 1px #696969; font-family: Arial, Sans-serif; border-bottom-style: solid; border-style: CadetBlue; " >Tambah Konsumen</a>
...
<form action="" method="post" align="center" style="margin-top: 145px; margin-bottom: 30px;">
    <ul>
            ...
            <input type = "text" name="nama_konsumen" id="nama_konsumen"required><br>
        <br>
            <label for="nomor_telp_konsumen"> nomor telp konsumen : </label><br>
            <input type = "text" name="nomor_telp_konsumen" id="nomor_telp_konsumen"required><br>
        <br>
