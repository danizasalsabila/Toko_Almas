...
$harga = query("SELECT * FROM harga ORDER BY harga_obat ASC");
...
//mysqli_fetch_object() seperti array tapi menggunakan panah, ex: (a->nama_harga) 
...
<head>
    ...
    <title>Halaman Harga | Sistem Informasi Toko Almas</title>
</head>
<body>
<header>
    ...
    <p>HARGA OBAT</p>
    <button type="button" class="btn btn-info" style="margin-top: 70px; margin-left: 101px; background-color: CadetBlue;"> <a href="tambahharga.php" style="color: Ivory;">+ add more</a></button> 
