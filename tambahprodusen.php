...
<head>
    ...
    <title>Tambah Produsen Obat | Sistem Informasi Toko Almas</title>
</head>
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <button type="button" class="btn btn-light"><a href="produsen.php" style="font-size: 15px;">Back to produsen</a>
                    </li>
                </ul>
            </div>
        </nav>
...
<form action="" method="post" align="center" action="/action_page.php" style="margin-top: 145px; margin-bottom: 30px;">
    <ul>
            <label for="id_produsen"> </label>
            <input type = "hidden" name="id_produsen" id="id_produsen"  autocomplete="off" required>
        <br>
            <label for="nomor_produksi_obat"> </label>
            <input type = "hidden" name="nomor_produksi_obat" id="nomor_produksi_obat">
        <br>
        ...
        <br>
            <label for="alamat"> alamat produsen obat : </label><br>
            <input type = "text" name="alamat" id="alamat"  autocomplete="off" required><br>
        <br>
            <label for="no_telp"> nomor telpon produsen : </label><br>
            <input type = "text" name="no_telp" id="no_telp"  autocomplete="off" required><br>
        <br> 
            <label for="kode_obat"> </label>
